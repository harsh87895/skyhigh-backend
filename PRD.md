...
- **120-second seat hold** accuracy (Â±1 second)
...
3. System validates:
   - If weight â‰¤ 25kg â†’ Continue to seat selection
   - If weight > 25kg â†’ Pause for payment
...
```
INITIATED â†’ AWAITING_PAYMENT â†’ SEAT_SELECTED â†’ COMPLETED
                â†“
            (if weight â‰¤ 25kg, skip payment)
```
...
- âœ… NFRs validated through load testing
- âœ… Zero seat conflicts in stress testing
...
- âœ… Seat hold/confirm logic
- âœ… Optimistic locking implementation
- âœ… Background job for hold expiration
- âœ… Baggage validation and payment pause

### Phase 3: Performance (Completed)
- âœ… Redis caching for seat maps
